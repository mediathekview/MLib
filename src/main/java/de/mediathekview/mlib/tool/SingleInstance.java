/*
 * MVSingleInstance Copyright (C) 2013 CrystalPalace crystalpalace1977@googlemail.com
 *
...
final public class SingleInstance {
  ...
  public boolean isAppAlreadyActive() {
    try {
      ...
      if (lock == null) {
        // we could not acquire the lock because another app already holds it...we are already
        // active
        closeLock();
        return true;
      }
