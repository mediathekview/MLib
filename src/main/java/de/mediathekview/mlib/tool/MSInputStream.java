 ...
 *
 * org.apache.hadoop.tools.util.ThrottledInputStream unter
 * http://www.apache.org/licenses/LICENSE-2.0 diente als Vorlage
 * 
...
public class MSInputStream extends InputStream {
  ...
  public MSInputStream(final InputStream in) {
    iStream = in;
  ...
  public String toString() {
    return "Download: " + "gelesen: " + (bytesGelesen > 0 ? bytesGelesen / 1000 : 0) + " kB, "
