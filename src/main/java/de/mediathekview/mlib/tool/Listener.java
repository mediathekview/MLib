...
public class Listener implements EventListener {
  ...
  public Listener(final int eereignis, final String kklasse) {
  ...
  public static synchronized void notify(final int ereignis, final String klasse) {
    for (final Listener l : listeners.getListeners(Listener.class)) {
      for (final int er : l.mvEreignis) {
