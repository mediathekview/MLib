...
public class FilmlistManager extends MessageCreator
{
    ...
    public boolean save(final FilmlistFormats aFormat, final Filmlist aFilmlist, final Path aSavePath)
    {
        try
        {
    ...
    private boolean compressFile(final AbstractFilmlistWriter aWriter, final Path aSavePath, final Filmlist aFilmlist)
    {
    ...
    public Optional<Filmlist> importList(final FilmlistFormats aFormat, final InputStream aInputStream)
            throws IOException
    {
