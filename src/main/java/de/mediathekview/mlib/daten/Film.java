...
public class Film
{
    ...
    private final Map<Resolution, FilmUrl> urls;
    ...
    public Map<Resolution, FilmUrl> getUrls()
    {
    ...
    public void addUrl(final Resolution aQuality, final FilmUrl aUrl)
    {
    ...
    public URL getUrl(final Resolution aQuality)
    {
