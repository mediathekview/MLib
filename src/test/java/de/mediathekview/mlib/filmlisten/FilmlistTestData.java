...
public class FilmlistTestData
{
    ...
    public Collection<Film> createFilme() throws MalformedURLException
    {
        ...
        testFilm1.addUrl(Qualities.SMALL, new FilmUrl(new URL("http://example.org/klein.mp4"), 42l));
        testFilm1.addUrl(Qualities.NORMAL, new FilmUrl(new URL("http://example.org/Test.mp4"), 42l));
        testFilm1.addUrl(Qualities.HD, new FilmUrl(new URL("http://example.org/hd.mp4"), 42l));
        ...
        testFilm2.addUrl(Qualities.SMALL, new FilmUrl(new URL("http://example.org/klein2.mp4"), 42l));
        testFilm2.addUrl(Qualities.NORMAL, new FilmUrl(new URL("http://example.org/Test2.mp4"), 42l));
        testFilm2.addUrl(Qualities.HD, new FilmUrl(new URL("http://example.org/hd2.mp4"), 42l));
        ...
        testFilm3.addUrl(Qualities.SMALL, new FilmUrl(new URL("http://example.org/klein.mp4"), 42l));
        testFilm3.addUrl(Qualities.NORMAL, new FilmUrl(new URL("http://example.org/Test.mp4"), 42l));
        testFilm3.addUrl(Qualities.HD, new FilmUrl(new URL("http://example.org/hd.mp4"), 42l));
