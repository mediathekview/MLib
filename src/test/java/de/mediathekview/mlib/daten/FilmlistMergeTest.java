...
public class FilmlistMergeTest {
    ...
    public void testMergeNotEqualsTitle() throws MalformedURLException
    {
        ...
        Film testFilm2 = createTestFilm2();
        Film testFilm3 = createTestFilm3();
        
        Filmlist testFilmlist1 = new Filmlist();
        testFilmlist1.add(testFilm1);
        testFilmlist1.add(testFilm2);
        testFilmlist1.add(testFilm3);
        
        Film testFilm4 = new Film(UUID.randomUUID(), testFilm3.getGeoLocations(), testFilm3.getSender(), testFilm3.getTitel(), testFilm3.getThema(), 
            testFilm3.getTime(), testFilm3.getDuration(),testFilm3.getWebsite());
        testFilm4.setTitel("testMergeNotEqualsTitle");
        Filmlist testFilmlist2 = new Filmlist();
        testFilmlist2.add(testFilm1);
        testFilmlist2.add(testFilm2);
        testFilmlist2.add(testFilm4);
        int sizeOld=testFilmlist1.getFilms().size();
    ...
    public void testMergeNotEqualsSender() throws MalformedURLException
    {
        ...
        Film testFilm4 = new Film(UUID.randomUUID(), testFilm3.getGeoLocations(), Sender.ARD, testFilm3.getTitel(), testFilm3.getThema(), 
            testFilm3.getTime(), testFilm3.getDuration(),testFilm3.getWebsite());
