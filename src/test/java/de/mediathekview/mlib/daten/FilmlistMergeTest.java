...
public class FilmlistMergeTest {
  ...
  public void testMergeNotEqualsSender() throws MalformedURLException {
    ...
    final Film testFilm4 = new Film(UUID.randomUUID(), Sender.ARD, testFilm3.getTitel(),
        testFilm3.getThema(), testFilm3.getTime(), testFilm3.getDuration());
    testFilm4.setWebsite(testFilm3.getWebsite());
  ...
  public void testMergeNotEqualsThema() throws MalformedURLException {
    ...
    final Film testFilm4 = new Film(UUID.randomUUID(), testFilm3.getSender(), testFilm3.getTitel(),
        testFilm3.getThema(), testFilm3.getTime(), testFilm3.getDuration());
    testFilm4.setWebsite(testFilm3.getWebsite());
