...
public class MSearchConst {
    ...
    public static final int SYSTEM_DOWNLOAD_SOFORT_STARTEN_NR = 67;
    public static final String SYSTEM = "system";
    public static final int SYSTEM_MAX_ELEM = 68;
